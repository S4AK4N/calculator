...
<template>
  <div>
    ...
    <div>
      <button @click="handleClick">4</button>
      <button @click="handleClick">5</button>
      <button @click="handleClick">6</button>
      <button @click="handleClick">-</button>
    </div>
    <div>
      <button @click="handleClick">7</button>
      <button @click="handleClick">8</button>
      <button @click="handleClick">9</button>
      <button @click="handleClick">*</button>
    </div>
    <div>
      <button @click="handleClick">0</button>
      <button @click="handleClick">=</button>
